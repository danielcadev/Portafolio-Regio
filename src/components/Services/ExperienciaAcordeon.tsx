    ...
    return (
      <Accordion type="single" collapsible className="mt-12 md:mt-16 w-full">
        <AccordionItem value="item-1">
          <AccordionTrigger
            className={`text-white hover:text-blue-500 ${relativeBold.className} p-4 rounded-t-lg bg-black border border-neutral-800`}
          >
            <Smartphone className="inline-block mr-2" size={20} />
            Experiencia en Desarrollo Móvil
          </AccordionTrigger>
          <AccordionContent
            className={`text-neutral-300 bg-black border border-neutral-800 border-t-0 p-4 ${relativeBook.className}`}
          >
        ...
        <AccordionItem value="item-2">
          <AccordionTrigger
            className={`text-white hover:text-blue-500 ${relativeBold.className} p-4 bg-black border border-neutral-800`}
          >
        ...
        <AccordionItem value="item-3">
          <AccordionTrigger
            className={`text-white hover:text-blue-500 ${relativeBold.className} p-4 bg-black border border-neutral-800 rounded-b-lg`}
          >
            <ScrollText className="inline-block mr-2" size={20} />
